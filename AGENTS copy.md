...
| Agente | Archivo | Responsabilidad | Modelo Simple | Modelo Complejo | Fallback |
|--------|---------|----------------|---------------|-----------------|----------|
| **Sammy** | `.opencode/agents/sammy.md` | Orquestador - recibe tareas y delega | Groq | MiniMax | DeepSeek |
| **WebWizard** | `.opencode/agents/webwizard.md` | Frontend + UX, widget, landing | Groq | MiniMax | DeepSeek |
| **DevGuardian** | `.opencode/agents/devguardian.md` | Calidad + Seguridad | MiniMax | MiniMax | DeepSeek |
| **DataAlchemist** | `.opencode/agents/dataalchemist.md` | DB + IA + n8n | MiniMax | MiniMax | DeepSeek |
| **GrowthPilot** | `.opencode/agents/growthpilot.md` | CRM + Marketing + Leads | Groq | MiniMax | DeepSeek |
| **ArchitectAI** | `.opencode/agents/architectai.md` | Infra + DevOps | MiniMax | MiniMax | DeepSeek |
| **DocsWriter** | `.opencode/agents/docs-writter.md` | Documentación - PRD, TECH_STACK, CHANGELOG | Groq | Groq | DeepSeek |

**Estrategia de Modelos:**
- **Groq** (gratis): Tareas simples, ediciones rápidas, documentación
- **MiniMax 2.7** ($10/mes): Tareas complejas, seguridad, IA, arquitectura
- **DeepSeek** (gratis): Fallback cuando los otros están agotados

**Modelos gratuitos:**
- `groq/llama-3.3-70b-instruct` — Tareas simples (gratis, rápido)
- `deepseek/deepseek-coder-33b-instruct` — Fallback (gratis)
- `minimax/MiniMax-M2.7` — Tareas complejas (Token Plan)
