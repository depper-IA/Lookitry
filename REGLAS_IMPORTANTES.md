...
# Reglas Críticas — Lookitry
RESPONDE SIEMPRE EN ESPAÑOL

## Reglas de Diseño (resumen rápido)
...
Cada vez que se realice cualquier cambio en el código, la IA DEBE documentarlo en `CHANGELOG_GEMINI.md` (en la raíz del workspace) antes de terminar la tarea. Cada entrada debe incluir:
- Fecha
