...
export const generationRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Rate limit de generación excedido para IP: ${req.ip}`);
...
export const authRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Rate limit de auth excedido para IP: ${req.ip}`);
...
export const loginRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Login rate limit excedido para IP: ${req.ip}`);
...
export const registerRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Register rate limit excedido para IP: ${req.ip}`);
...
export const adminLoginRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Admin login rate limit excedido para IP: ${req.ip}`);
...
export const globalRateLimiter = rateLimit({
  ...
  handler: (req: Request, res: Response) => {
    ...
    console.warn(`â ï¸  Rate limit global excedido para IP: ${req.ip}`);
