    ...
    try {
      ...
      if (!skipPreferenceCheck) {
        ...
        if (!emailEnabled) {
          ...
          console.log(`â­ï¸  Email de bienvenida omitido para ${brand.email} (preferencias)`);
  ...
  async sendExpirationReminder(brand: Brand, daysRemaining: number): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Recordatorio omitido para ${brand.email} (email deshabilitado)`);
      ...
      if (daysRemaining === 7) {
        ...
        if (!reminder7Enabled) {
          ...
          console.log(`â­ï¸  Recordatorio 7 días omitido para ${brand.email} (preferencias)`);
        ...
        if (!reminder3Enabled) {
          ...
          console.log(`â­ï¸  Recordatorio 3 días omitido para ${brand.email} (preferencias)`);
  ...
  async sendSuspensionNotice(brand: Brand): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Notificación de suspensión omitida para ${brand.email} (preferencias)`);
  ...
  async sendRenewalConfirmation(brand: Brand): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Confirmación de renovación omitida para ${brand.email} (preferencias)`);
  ...
  async sendUsageAlert(
    ...
    try {
      ...
      if (!usageAlertsEnabled) {
        ...
        console.log(`â­ï¸  Alerta de uso omitida para ${brand.email} (preferencias)`);
  ...
  async sendTrialEndingSoon(brand: Brand, daysRemaining: number): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Trial ending soon omitido para ${brand.email} (email deshabilitado)`);
      ...
      await emailService.sendEmail({
        ...
        subject: `â° Tu trial en LOOKITRY termina en ${daysRemaining} día${daysRemaining > 1 ? 's' : ''}`,
  ...
  async sendTrialNudgeSetup(brand: Brand, daysRemaining: number): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Trial nudge setup omitido para ${brand.email} (email deshabilitado)`);
  ...
  async sendOnboardingProductReminder(brand: Brand): Promise<void> {
    ...
    try {
      ...
      if (!emailEnabled) {
        ...
        console.log(`â­ï¸  Onboarding product reminder omitido para ${brand.email} (email deshabilitado)`);
