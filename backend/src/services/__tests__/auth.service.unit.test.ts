...
// Tests unitarios para AuthService — login, verifyEmail, getBrandById, resetPassword
...
// —â Importar DESPUñS de los mocks —————————————————————â
...
describe('AuthService', () => {
  ...
  describe('requestPasswordReset', () => {
    ...
    it('no debe lanzar error aunque el email no exista (seguridad — no revelar existencia)', async () => {
