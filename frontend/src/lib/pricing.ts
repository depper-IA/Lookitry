...
const DEFAULTS: PricingConfig = {
  basic: {
    ...
    features: [
      ...
      '400 pruebas virtuales / mes',
      'Logo y colores de marca',
      'Diseño limpio y elegante',
      'Link para tu página web',
      'Estadísticas de uso',
    ],
    features_excluidas: [
      'Varios estilos de diseño',
      'Texto de botones personalizado',
  ...
  pro: {
    ...
    features: [
      ...
      'Link para Instagram y WhatsApp',
      'Estadísticas avanzadas',
      'Estilos de diseño adicionales',
      'Botones personalizados',
      'Mensaje de bienvenida propio',
      'Enlace 100% personalizado',
  ...
  enterprise: {
    ...
    features: [
      'Mínimo 50 productos activos',
      'Volumen de pruebas a medida',
      'Marca Blanca (Sin nuestro logo)',
      'Panel de Analítica Profesional',
      'Acceso total para desarrolladores',
    ],
    features_excluidas: [],
  },
  mini_landing: {
    ...
    subtitulo: 'Tu Tienda Virtual lista en horas',
    boton_texto: 'Quiero mi tienda virtual',
    features: [
      'Página pública activa',
      'Espejo Digital integrado',
      'Varios diseños a elegir',
