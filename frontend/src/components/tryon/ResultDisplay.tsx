    ...
    <>
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col gap-2 md:gap-3">
          ...
          {/* Precio + CTA de compra - solo en non-plugin view */}
          {!pluginView && productPrice && (
            <div className="rounded-2xl border p-4 text-center" style={{ backgroundColor: cardBg || '#faf8f5', borderColor: cardBorder || '#f3f4f6' }}>
              <p className="text-[10px] font-black uppercase tracking-widest mb-1" style={{ color: mutedColor }}>Precio del producto</p>
              <p className="text-2xl md:text-3xl font-black italic" style={{ color: textColor }}>
                {new Intl.NumberFormat('es-CO', { style: 'currency', currency: 'COP', minimumFractionDigits: 0 }).format(productPrice)}
              </p>
            </div>
          )}
          ...
          <button
            onClick={onReset}
            className="w-full py-2.5 text-xs font-medium transition-all flex items-center justify-center gap-1.5"
