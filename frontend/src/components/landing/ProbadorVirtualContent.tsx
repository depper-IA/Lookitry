        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-40 mt-12 flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link href="/marca/wilkie-devs" className="rounded-2xl bg-[#FF5C3A] px-12 py-6 text-sm font-bold text-white shadow-xl shadow-[#FF5C3A]/30 transition-all hover:scale-105">
                Prueba Premium
              </Link>
