...
// Componente client-side usado como homepage en app/page.tsx
// Contiene el diseño DarkTech de ventas con copy irresistible de mini-landing
...
export default function MiniLandingHomepage() {
      ...
      <main className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            <div>
              <SectionLabel text="Probador Virtual con IA" />
          ...
          <div className="mb-20 pt-10 border-t border-white/10">
            ...
            <div className="mt-16 text-center">
              ...
              <p className="mt-5 text-white/20 text-xs uppercase tracking-widest font-bold">
                Min-Landing — Pago único $650.000 COP · Sin mensualidad adicional
              </p>
            </div>
          </div>
