...
export default function LandingPlugin() {
  ...
  return (
    <section id="plugin" className="bg-black dark:bg-white py-20 sm:py-24 md:py-32 px-4 sm:px-6 overflow-hidden relative" aria-label="Plugin WooCommerce">
      <div className="max-w-7xl mx-auto px-0 sm:px-6">
        <div className="text-center lg:text-left mb-12 sm:mb-16">
          ...
          <p className="text-white/60 dark:text-text-muted text-base sm:text-lg font-dm-sans max-w-2xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 md:mb-20">
          {features.map((item, i) => (
            <motion.div
              ...
              className="group p-6 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-white/10 dark:bg-neutral-50 border border-white/10 dark:border-gray-200 hover:bg-white/15 dark:hover:bg-neutral-100 hover:shadow-2xl hover:shadow-accent/5 transition-all duration-500"
            >
              <motion.div
              ...
              <p className="text-white/60 dark:text-text-muted text-sm leading-relaxed font-dm-sans">{item.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between pt-8 sm:pt-10 md:pt-12 gap-6 sm:gap-8 md:gap-10">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-white/10 dark:bg-black/5 border border-white/20 dark:border-black/10">
