...
export default function LandingPricing({ pricing, currency, trm }: LandingPricingProps) {
  ...
  return (
    <section id="planes" className="py-20 sm:py-24 md:py-32 lg:py-40 px-4 sm:px-6 bg-[#0d0d0d] relative overflow-hidden" aria-label="Planes y precios">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100%] h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent" aria-hidden="true" />

      <div className="max-w-7xl mx-auto px-0 sm:px-6">
        <div className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24">
          <SectionTag text="Planes de Crecimiento" light />
          <h2 className="font-jakarta text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white mb-4 sm:mb-6">
            Precios claros, <span className="text-[#FF5C3A]">sin sorpresas.</span>
          </h2>
          <p className="font-dm-sans text-base sm:text-lg text-white/70 max-w-xl mx-auto">Activa tu plan en minutos con pasarelas 100% seguras y soporte en español.</p>
        </div>

        <div className="features-grid flex flex-wrap justify-center items-stretch gap-6 sm:gap-8 lg:gap-10">
          {/* Básico */}
          <div className="feature-card w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.33%-2.5rem)] max-w-sm bg-[#1a1a1a] border border-white/10 rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] p-6 sm:p-8 md:p-10 flex flex-col hover:border-[#FF5C3A]/60 transition-all duration-500 relative">
            {hasBasicDiscount && basicLabel && (
              <div className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 bg-emerald-500 text-white text-[8px] sm:text-[9px] font-bold uppercase tracking-widest px-4 sm:px-5 py-1.5 sm:py-2 rounded-full shadow-lg flex items-center gap-1.5 whitespace-nowrap">
            ...
            <h3 className="font-jakarta font-bold text-2xl sm:text-3xl text-white mb-3 sm:mb-4">Básico</h3>
            <div className="flex flex-col mb-6 sm:mb-8">
              <div className="flex items-baseline gap-2">
                <span className="font-jakarta font-black text-3xl sm:text-4xl text-white tracking-tighter">{formatPrice(basicPrice)}</span>
              ...
              {hasBasicDiscount && basicOriginal > basicPrice && (
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-[12px] sm:text-[14px] text-white/40 line-through">{formatPrice(basicOriginal)}</span>
                  <span className="text-[10px] sm:text-[11px] font-bold text-emerald-400">-{Math.round((1 - basicPrice / basicOriginal) * 100)}%</span>
                </div>
              )}
            </div>
            ...
            <Link href={`/checkout?plan=BASIC&currency=${currency}`} className="mt-auto w-full py-4 sm:py-5 rounded-xl sm:rounded-[1.5rem] bg-white/10 border border-white/10 text-white font-bold text-sm text-center hover:bg-white hover:text-black transition-all">
              Contratar Básico
            </Link>
          </div>

          {/* Pro */}
          <div className="feature-card w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.33%-2.5rem)] max-w-sm bg-[#1c1c1c] border border-[#FF5C3A]/60 rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] p-6 sm:p-8 md:p-10 flex flex-col relative z-10 shadow-[0_40px_100px_rgba(255,92,58,0.15)] scale-[1.02]">
            ...
            {!hasProDiscount && (
              <div className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 bg-[#FF5C3A] text-white text-[8px] sm:text-[9px] font-bold uppercase tracking-widest px-4 sm:px-5 py-1.5 sm:py-2 rounded-full shadow-lg whitespace-nowrap">Plan Más Solicitado</div>
            )}
            ...
            <Link href={`/checkout?plan=PRO&currency=${currency}`} className="mt-auto w-full py-4 sm:py-5 rounded-xl sm:rounded-[1.5rem] bg-[#FF5C3A] text-white font-bold text-sm text-center hover:bg-white hover:text-black transition-all shadow-xl shadow-[#FF5C3A]/20">
              Activar Plan Pro
            </Link>
          </div>

          {/* Enterprise */}
          <div className="feature-card w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.33%-2.5rem)] max-w-sm bg-[#1a1a1a] border border-white/10 rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] p-6 sm:p-8 md:p-10 flex flex-col hover:border-[#FF5C3A]/60 transition-all duration-500">
            ...
            <h3 className="font-jakarta font-bold text-2xl sm:text-3xl text-white mb-3 sm:mb-4">Enterprise</h3>
            <div className="flex items-baseline gap-2 mb-6 sm:mb-8">
              <span className="font-jakarta font-black text-3xl sm:text-4xl text-white tracking-tighter">Custom</span>
            </div>
            <div className="h-[1px] w-full bg-white/10 mb-6 sm:mb-8 md:mb-10" />
            <ul className="flex flex-col gap-4 sm:gap-5 mb-8 sm:mb-10 md:mb-12 shrink-0">
            ...
            <Link href="/contacto" className="mt-auto w-full py-4 sm:py-5 rounded-xl sm:rounded-[1.5rem] bg-white/10 border border-white/10 text-white font-bold text-sm text-center hover:border-[#FF5C3A] hover:text-[#FF5C3A] transition-all">
              Hablar con Ventas
            </Link>
          </div>
        </div>
