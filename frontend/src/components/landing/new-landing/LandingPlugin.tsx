...
export default function LandingPlugin() {
  ...
  return (
    <section id="plugin" className="bg-white dark:bg-[#0d0d0d] py-20 sm:py-24 md:py-32 px-4 sm:px-6 overflow-hidden relative border-t border-[#eeebe7] dark:border-white/5" aria-label="Plugin WooCommerce">
      <div className="max-w-7xl mx-auto px-0 sm:px-6">
        <div className="text-center lg:text-left mb-12 sm:mb-16">
          ...
          <h3 className="font-jakarta text-3xl sm:text-4xl md:text-5xl font-bold text-[#0a0a0a] dark:text-white mb-4 sm:mb-6 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 md:mb-20">
          {features.map((item, i) => (
            <div key={i} className="group p-6 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-[#fcfaf8] dark:bg-[#141414] border border-[#eeebe7] dark:border-white/5 hover:bg-white dark:hover:bg-[#1a1a1a] hover:shadow-2xl hover:shadow-[#FF5C3A]/5 transition-all duration-500">
              ...
              <h4 className="font-jakarta font-bold text-lg sm:text-xl text-[#0a0a0a] dark:text-white mb-3 sm:mb-4">{item.title}</h4>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between pt-8 sm:pt-10 md:pt-12 border-t border-[#eeebe7] dark:border-white/5 gap-6 sm:gap-8 md:gap-10">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            <Link href="#" className="flex items-center gap-2 sm:gap-3 bg-[#FF5C3A] px-6 sm:px-10 py-4 sm:py-5 rounded-full text-white hover:bg-[#0a0a0a] dark:hover:bg-white dark:hover:text-[#0a0a0a] transition-all shadow-xl shadow-[#FF5C3A]/20 active:scale-95 group text-sm">
            ...
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:gap-8 md:gap-10 opacity-100 transition-all duration-700">
            <span className="text-[9px] sm:text-[10px] font-bold text-[#000000] dark:text-white uppercase tracking-[0.15em] sm:tracking-[0.2em]">Compatible con:</span>
            <div className="flex items-center gap-6 sm:gap-8">
              <img src="/integrations/Woo_logo_color.svg" alt="WooCommerce" className="h-7 sm:h-8 md:h-10" />
              <img src="/integrations/shopify.svg" alt="Shopify" className="h-5 sm:h-6 md:h-8 grayscale hover:grayscale-0 transition-all" />
              <img src="/integrations/Wix.svg" alt="Wix" className="h-5 sm:h-6 md:h-8 grayscale hover:grayscale-0 transition-all" />
            </div>
          </div>
        </div>
      </div>
