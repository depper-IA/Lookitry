...
export default function LandingFooter() {
  ...
  return (
    <footer className="theme-bg-base theme-text pt-12 sm:pt-20 md:pt-24 lg:pt-28 relative z-10 overflow-x-hidden" role="contentinfo">
      ...
      <div className="w-full bg-[#FF5C3A]">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:py-8 md:px-12">
