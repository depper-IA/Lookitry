      ...
      <div className="max-w-7xl mx-auto px-0 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <h2 className="font-jakarta text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#0a0a0a] dark:text-white mb-4 sm:mb-6 leading-tight">
              Tu tienda online, <br />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mb-8 sm:mb-10">
              {features.map((feat, idx) => (
                <div key={idx} className="bg-[#f8f6f4] dark:bg-[#1a1a1a] border border-[#e8e4df] dark:border-white/5 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl hover:bg-white dark:hover:bg-[#141414] hover:shadow-xl transition-all group">
                  ...
                  <h4 className="font-jakarta font-bold text-sm sm:text-base text-[#0a0a0a] dark:text-white mb-1.5 sm:mb-2">{feat.title}</h4>
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <Link href="/register" className="bg-[#FF5C3A] text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm transition-all hover:scale-105 shadow-xl shadow-[#FF5C3A]/20">
                Crear mi página ahora
              </Link>
              <Link href="/planes" className="bg-[#0a0a0a] dark:bg-white dark:text-[#0a0a0a] text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm transition-all hover:bg-[#FF5C3A] dark:hover:bg-[#FF5C3A] dark:hover:text-white">
          ...
          <div className="hidden lg:block relative">
            <div className="relative z-10 rounded-2xl sm:rounded-[2rem] overflow-hidden border border-[#e8e4df] dark:border-white/10 shadow-2xl">
