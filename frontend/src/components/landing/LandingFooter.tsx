    ...
    <footer className="bg-[#050505] border-t border-[#1a1a1a]">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 py-12 md:py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-[12px] text-[#555] leading-relaxed mb-5">
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="flex items-center gap-2 text-[12px] text-[#555] hover:text-[#aaa] transition-colors"
            >
        ...
        {/* Columna 2 — Producto */}
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest text-[#333] mb-4">Producto</p>
          <ul className="flex flex-col gap-2.5">
            {[
              ...
              <li key={l.href}>
                <Link href={l.href} className="text-[12px] text-[#555] hover:text-[#aaa] transition-colors">
                  {l.label}
                </Link>
              </li>
            ))}
        ...
        {/* Columna 3 — Empresa */}
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest text-[#333] mb-4">Empresa</p>
          <ul className="flex flex-col gap-2.5">
            {[
        ...
        {/* Columna 4 — CTA */}
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest text-[#333] mb-4">Empieza hoy</p>
      ...
      <div className="border-t border-[#111] px-6 md:px-8 py-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <Link
            href="/admin/login"
            className="text-[11px] text-[#222] hover:text-[#444] transition-colors"
          >
            Admin
          </Link>
        </div>
