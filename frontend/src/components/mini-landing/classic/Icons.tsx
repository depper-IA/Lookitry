...
export function StarIcon({ className, style, filled }: { className?: string; style?: React.CSSProperties; filled?: boolean }) {
  return (
...
export function MapPinIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
