...
// -- Shared: Modal de activación (bloqueante) ----------------------------------
function ActivationModal({ primaryColor }: { primaryColor: string }) {
  ...
  // Countdown: 23:59:59 que se reinicia cada día (urgencia)
      ...
      <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-2xl" style={{ backgroundColor: '#0f0f0f', border: '1px solid #2a2a2a' }}>
        ...
        <div className="px-7 py-8 text-center">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight mb-2" style={{ fontFamily: 'Syne, sans-serif' }}>
            Activa tu página de marca
          </h2>
          <p className="text-sm text-gray-400 leading-relaxed mb-6">
            Estás viendo una vista previa. Activa tu mini-landing para que tus clientes puedan verla sin restricciones.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-xs font-bold px-2 py-1 rounded-full" style={{ backgroundColor: primaryColor + '20', color: primaryColor }}>Pago único</span>
          </div>

          {/* Features */}
          <ul className="text-left space-y-2 mb-7">
            {[
              'Página pública con tu catálogo completo',
              'Probador virtual integrado con IA',
              'Botón de WhatsApp flotante',
              '3 templates de diseño a elegir',
              'Sin mensajes de activación',
            ].map(f => (
          ...
          >
            ...
            Activar mi página ahora — $500.000
          </a>
          <p className="text-[11px] text-gray-600 mt-3">Pago único · Sin mensualidad adicional · Activación inmediata</p>
        </div>
      </div>
    </div>
  );
