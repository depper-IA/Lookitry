...
function GlobeIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" /></svg>;
}
function ShoppingIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>;
}
function FileIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>;
}
...
function PlaybookIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>;
}
function RiskIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>;
}
function FunnelIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>;
}
...
const adminNav = [
  {
    ...
    items: [
      ...
      { href: '/admin/funnel', label: 'Funnel SaaS', icon: FunnelIcon },
      { href: '/admin/risk', label: 'Riesgo', icon: RiskIcon },
      { href: '/admin/playbooks', label: 'Playbooks', icon: PlaybookIcon },
      { href: '/admin/agents', label: 'Agents Activity', icon: BotIcon },
    ],
  },
  {
    label: 'CLIENTES',
    items: [
      ...
      { href: '/admin/conversion', label: 'Conversion', icon: ConversionIcon },
    ],
  },
  {
    label: 'ANALYTICS',
    items: [
      ...
      { href: '/admin/unit-economics', label: 'Economia Unitaria', icon: DollarSign },
    ],
  },
  {
    label: 'MARKETING',
    items: [
      ...
      { href: '/admin/trial-campaigns', label: 'Trial Campaigns', icon: TargetIcon },
  ...
  },
  {
    label: 'FINANZAS',
    items: [
      { href: '/admin/ia-costs', label: 'Creditos IA', icon: Brain },
    ],
  },
  {
    label: 'CONFIGURACION',
    items: [
      ...
      { href: '/admin/payment-settings', label: 'Payments', icon: PaymentsIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/blog', label: 'Blog', icon: FileIcon },
  ...
  },
  {
    label: 'HELP',
    items: [
      { href: '/admin/soporte', label: 'Soporte', icon: UsersIcon },
      { href: '/admin/feedback', label: 'Feedback', icon: TargetIcon },
    ],
  },
];
