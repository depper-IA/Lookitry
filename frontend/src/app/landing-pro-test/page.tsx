...
export default function LandingProTest() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#FF5C3A]/30 selection:text-[#FF5C3A] font-dm-sans overflow-x-hidden">
      ...
      <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 bg-transparent py-8 transition-[padding,background-color,backdrop-filter] duration-500 ease-in-out">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-5">
            ...
            {/* Selector de moneda (Ubicación: Izquierda junto al logo) */}
            <div className="hidden sm:flex items-center bg-white/5 border border-white/10 rounded-full px-3 py-1.5 gap-2.5 ml-2">
              <span className="text-[8px] font-bold text-[#FF5C3A] cursor-default">COP</span>
              <div className="w-[1px] h-2.5 bg-white/10" />
              <button className="text-[8px] font-bold text-white/30 hover:text-white cursor-pointer transition-colors uppercase">USD</button>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            {[
              ...
              <Link
                key={item.label}
                href={item.href}
                className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/50 hover:text-[#FF5C3A] transition-all duration-300"
              >
                {item.label}
              </Link>
            ))}
      ...
      {/* ── FOOTER ──────────────────────────────────────────────────────────── */}
      <footer className="bg-[#080808] pt-32 pb-12 px-6 md:px-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-20 mb-24">
            ...
            <div>
              ...
              <p className="text-white/70 text-base leading-relaxed max-w-xs mb-10 font-dm-sans font-light">
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <Link key={idx} href={item.href} className="w-11 h-11 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-white/60 hover:text-white hover:bg-[#FF5C3A] hover:border-[#FF5C3A] transition-all">
                    <item.Icon size={18} />
                  </Link>
                ))}
                <Link href="#" className="w-11 h-11 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-white/60 hover:text-white hover:bg-[#FF5C3A] hover:border-[#FF5C3A] transition-all">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-5">
                {['Probador Virtual', 'Mini-Landing Pro', 'Plugin WooCommerce', 'API Developer', 'Planes Mensuales'].map(l => (
                  <li key={l}><Link href="#" className="text-sm text-white/60 font-dm-sans hover:text-[#FF5C3A] transition-colors">{l}</Link></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-5">
                {['Centro de Ayuda', 'Blog Técnico', 'Partners', 'Casos de Éxito', 'Estado del sistema'].map(l => (
                  <li key={l}><Link href="#" className="text-sm text-white/60 font-dm-sans hover:text-[#FF5C3A] transition-colors">{l}</Link></li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-5">
                {['Términos de Servicio', 'Políticas Privacidad', 'Data Policy', 'Cookies', 'Aviso Legal'].map(l => (
                  <li key={l}><Link href="#" className="text-sm text-white/60 font-dm-sans hover:text-[#FF5C3A] transition-colors">{l}</Link></li>
                ))}
              </ul>
            </div>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="text-white/10 text-[10px] font-bold uppercase tracking-[0.3em] font-dm-sans">
              © {new Date().getFullYear()} Lookitry / Una división de <Link href="https://wilkiedevs.com" target="_blank" className="hover:text-white transition-colors">Wilkie Devs SAS</Link>
            </div>
