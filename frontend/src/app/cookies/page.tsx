      ...
      <main className="min-h-screen theme-bg-base">
        ...
        <section className="px-6 md:px-8 py-12 md:py-16">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="rounded-3xl border theme-border theme-bg-card p-6">
              <p className="text-[#FF5C3A] text-[11px] uppercase tracking-wider font-semibold">Cookies necesarias</p>
              <p className="text-sm mt-2 theme-text">Autenticación, seguridad de sesión y funcionamiento base del sitio.</p>
            </div>
            <div className="rounded-3xl border theme-border theme-bg-card p-6">
              <p className="text-[#FF5C3A] text-[11px] uppercase tracking-wider font-semibold">Privacidad</p>
              <p className="text-sm mt-2 theme-text">No vendemos datos personales ni usamos tracking publicitario invasivo.</p>
            </div>
            <div className="rounded-3xl border theme-border theme-bg-card p-6">
              <p className="text-[#FF5C3A] text-[11px] uppercase tracking-wider font-semibold">Control del usuario</p>
              <p className="text-sm mt-2 theme-text">Puedes bloquear o eliminar cookies desde la configuración de tu navegador.</p>
            </div>
          </div>
        </section>
      </main>
