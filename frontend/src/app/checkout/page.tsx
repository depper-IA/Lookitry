              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-sm text-[#999] mt-1">Ingresa tu correo para continuar. Si ya tienes cuenta, inicia sesión.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        type="email"
                        value={email}
                        onChange={e => { setEmail(e.target.value); setEmailError(''); setEmailExists(null); }}
                ...
                <div className="mt-10">
                  <button
                    ...
                    className="w-full text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
